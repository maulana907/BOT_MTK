...
prefix = "!"
name = "~ MTK BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN MTKBOT😁"
rmenu = "HAI TEMEN MTKBOT👋 JANGAN LUPA DONASI YAA:)"
botinfo = "UNTUK INVITE BOT SILAHKAN DONASI DULU YAA:)"
limitt = 10
memberLimit = 2
ban = []
premium = ["6289523731135@s.whatsapp.net"]
...
async function starts() {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["6289523731135@s.whatsapp.net"] // owner number ubah aja
